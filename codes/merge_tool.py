...
def merge(param,inName,outName,directory):
    ...
    cmd="flash2 -q -m "+mf+" "+inName+"_1.fastq "+inName+"_2.fastq  -t "+cpus+' -o '+outName+' -d '+directory+' '+aux_flash
    print(cmd)
    os.system(cmd) 
...
def mergeGeneric(param,inName1,inName2,outName,directory):
    ...
    mf=str(param.fb)
    aux_flash=str(param.flash_aux);
    cmd="flash2 -q -m "+mf+" "+inName1+" "+inName2+"  -t "+cpus+' -o '+outName+' -d '+directory+' '+aux_flash
    print(cmd)
    os.system(cmd) 
