...
from assembly_annotation_tool import assembly
from assembly_annotation_tool import annotate_blastn
from assembly_annotation_tool import annotate_kaiju
...
def seq_16Sremoval(direct,param,outName,flags):
    ...
    if flags.seq_16sSeqs:
        ...
        print cmd
        os.system(cmd)   
        #index=database_fm9.split('.')[0]+'.index'
        #decoseq(firstC,index,outFile+"_1.result",outFile+"_1.listb")
        
        #Mapping the 16S_database againt the clean reads
