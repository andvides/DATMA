...
from assembly_annotation_tool import *
...
if __name__ == "__main__":
    ...
    if args.file:
        ...
        for binName in bins: #for each bin generated
            ...
            assembly_annotation(str(suffix),str(prefix),binName,contigsFile,contigsFile_stat,orfsFile,blastFile,str(database_nt),kaijuFile,str(database_kaiju),str(param.cpus),str(assembler),bool(use_ref),str(ref_name),str(asm_aux),str(ORF_aux),str(blast_aux),str(kaiju_aux),str(quast_aux))
