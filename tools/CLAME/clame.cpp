...
int main(int argc,char *argv[])
{
    ...
    Names  names;
    //struct Parameters {float edges; float tol; int numThreads; int query_size; bool enablePrint; bool printOnlyNames; bool loadFM9;int sizeBin; bool fastq; int ld; int w; string forward_reverse;};
    Parameters parameters={3.0,0.5,1,70,false,false,false,1000,false,2,0,"fr"};
